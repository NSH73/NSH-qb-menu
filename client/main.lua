...
local function startZoom()
    ...
    SetCamCoord(menuCam, coords.x, coords.y, coords.z)
    SetCamRot(menuCam, rot.x, rot.y, rot.z, 2)
    SetCamFov(menuCam, fov)
    RenderScriptCams(true, true, 500, true, true)
    SetCamFov(menuCam, math.max(10.0, fov - 10.0))
end

local function stopZoom()
    if not menuCam then return end
